...
import OptionPopoverView from '../components/OptionPopover/OptionPopoverView';

export default {
  title: 'Option/Popover',
  component: OptionPopoverView,
};
...
export const PopoverView = () => {
  ...
  function showEditConfirm() {
    ...
    confirm({
      ...
      cancelText: "취소",
      onOk() {
        console.log("confirmEdit 실행", editInputRef.current.value);
      },
      onCancel() {
      },
    });
